...
const WatchPage = () => {
    ...
    const { data, error } = useQuery(["watchData", title], async () => {
        try {
            const response = await axios.get(`/api/watches//${title}`);;
        ...
        <div className="flex flex-col md:flex-row -mx-4">
            <div className="md:flex-1 px-4">
                <div className="h-[460px] rounded-lg bg-gray-300 mb-4">
                    <Image className="w-full h-full object-cover" src={data?.image} isZoomed alt="Product Image" />
                </div>
            ...
            <div className="md:flex-1 px-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600 text-sm mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
